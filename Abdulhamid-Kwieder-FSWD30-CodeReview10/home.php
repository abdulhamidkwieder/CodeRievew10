...
<html>
  <head>
    <meta charset="utf-8">
    <title>Welcome to your Acount<?php echo $userRow['first_name']; ?></title>
  ...
  <a class="navbar-brand" href="#home.php">
    <img src="http://www.patriotspointfoundation.org/Images/home_button.png" width="150" class="d-inline-block align-top" alt="">
  </a>
  <a class="btn btn-primary" href="logout.php?logout">Sign Out</a>
</nav>

<div id="wtext">
  <h1 style="color: red;">Welcome <?php echo $userRow['first_name']; ?> to your Acount </h1>
</div>
      ...
      echo '
       <div class="col-md-4">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Author: '.$row1["fk_author_id"].'</li>
              ...
              while($row2 = $result2->fetch_assoc()) {
                echo '
                 <div class="col-md-4">
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item">Author: '.$row2["fk_author_id"].'</li>
              ...
              while($row3 = $result3->fetch_assoc()) {
                echo '
                 <div class="col-md-4">
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item">Author: '.$row3["fk_author_id"].'</li>
              ...
              while($row4 = $result4->fetch_assoc()) {
                echo '
                 <div class="col-md-4">
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item">Author: '.$row4["fk_author_id"].'</li>
